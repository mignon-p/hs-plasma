...
poolCreateOptions =
  ...
  , NFELD(kSize,                         pcoSize        , NumWord64)
  , NFELD("toc-capacity|index-capacity", pcoTocCapacity , NumWord64)
...
poolInfo =
  ...
  , NFELD("size",                        piSize           , NumWord64)
  , NFELD("size-used",                   piSizeUsed       , NumWord64)
  , NFELD("mmap-pool-version",           piMmapPoolVersion, NumWord32)
  , NFELD("slaw-version",                piSlawVersion    , NumWord32)
  , NFELD("toc-capacity|index-capacity", piTocCapacity    , NumWord64)
  , NFELD("toc-step|index-step",         piTocStep        , NumWord64)
  , NFELD("toc-count|index-count",       piTocCount       , NumWord64)
  ...
  , NFELD("net-pool-version",            piNetPoolVersion , NumWord32)
  ]
